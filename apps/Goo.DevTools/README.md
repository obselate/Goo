...
dotnet tool install --global Goo.DevTools.App --version 0.5.0 --add-source artifacts/packages
```
...
The app targets `net10.0` and references Goo 0.5.0.

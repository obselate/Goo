...
dotnet tool install --global Goo.DevTools.App --version 0.4.1 --add-source artifacts/packages
```
...
The app targets `net10.0` and references Goo 0.4.1.

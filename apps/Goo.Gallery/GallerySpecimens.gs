...
class ComposeChapter : Cell, IDisposable {
      ...
      children.Add(Container{
        ...
        Children: {
          Text{
            ...
            FontSize: if slot < 2 { 8.0 } else { if slot < 4 { 10.0 } else { 14.0 } },
            FontWeight: 700.0,
        ...
        Container{
          ...
          Children: {
            Container{
              ...
              MaxWidth: Length.Percent(100.0),
              MinWidth: 0.0,
              Height: if narrowPoster { 360.0 } else { 330.0 },
              TransitionMs: 180.0,
              TransitionEasing: Easing.EaseInOut,
                ...
                Container{
                  ...
                  Children: {
                    Container{
                      ...
                      Height: if narrowPoster { 120.0 } else { 160.0 },
                      FlexGrow: 3.0,
                      FlexShrink: 1.0,
                      FlexBasis: if narrowPoster { 280.0 } else { 300.0 },
                      TransitionMs: 180.0,
                      TransitionEasing: Easing.EaseInOut,
                      ...
                      Children: {
                        ...
                        Text{
                          Content: "FORM",
                          FontSize: if narrowPoster { 40.0 } else { 58.0 },
                          TransitionMs: 180.0,
                          TransitionEasing: Easing.EaseInOut,
                    ...
                    Container{
                      ...
                      Height: if narrowPoster { 80.0 } else { 160.0 },
                      FlexGrow: 1.0,
                      FlexShrink: 1.0,
                      FlexBasis: if narrowPoster { 110.0 } else { 135.0 },
                      TransitionMs: 180.0,
                      TransitionEasing: Easing.EaseInOut,
                      TransitionProperties: GalleryPosterTransitions.Module,
                      MinWidth: 84.0,
                      ...
                      Children: {
                        ...
                        Container{
                          Width: if narrowPoster { 34.0 } else { 48.0 },
                          Height: if narrowPoster { 34.0 } else { 48.0 },
                          BorderRadius: if narrowPoster { 17.0 } else { 24.0 },
                          TransitionMs: 180.0,
                          TransitionEasing: Easing.EaseInOut,
                          ...
                          Children: {
                            Text{
                              Content: "03",
                              FontSize: if narrowPoster { 10.0 } else { 13.0 },
                              TransitionMs: 180.0,
                              TransitionEasing: Easing.EaseInOut,
                              TransitionProperties: GalleryPosterTransitions.Type,
                              FontWeight: 800.0,
                    ...
                    Container{
                      ...
                      Height: if narrowPoster { 80.0 } else { 90.0 },
                      FlexGrow: 2.0,
                      FlexShrink: 1.0,
                      FlexBasis: if narrowPoster { 180.0 } else { 260.0 },
                      TransitionMs: 180.0,
                      TransitionEasing: Easing.EaseInOut,
                      TransitionProperties: GalleryPosterTransitions.Module,
                      MinWidth: 150.0,
                      ...
                      Children: {
                        Text{
                          Content: "FLOW",
                          FontSize: if narrowPoster { 30.0 } else { 42.0 },
                          TransitionMs: 180.0,
                          TransitionEasing: Easing.EaseInOut,
                          TransitionProperties: GalleryPosterTransitions.Type,
                          FontWeight: 850.0,
                    ...
                    Container{
                      ...
                      Height: if narrowPoster { 76.0 } else { 90.0 },
                      FlexGrow: 1.0,
                      FlexShrink: 1.0,
                      FlexBasis: if narrowPoster { 86.0 } else { 110.0 },
                      TransitionMs: 180.0,
                      TransitionEasing: Easing.EaseInOut,
                      TransitionProperties: GalleryPosterTransitions.Module,
                      MinWidth: 76.0,
                      ...
                      Children: {
                        ...
                        Text{
                          Content: "06",
                          FontSize: if narrowPoster { 24.0 } else { 32.0 },
                          TransitionMs: 180.0,
                          TransitionEasing: Easing.EaseInOut,
                          TransitionProperties: GalleryPosterTransitions.Type,
                          FontWeight: 850.0,
                    ...
                    Container{
                      ...
                      FlexGrow: 1.0,
                      FlexShrink: 2.0,
                      FlexBasis: if narrowPoster { 86.0 } else { 100.0 },
                      TransitionMs: 180.0,
                      TransitionEasing: Easing.EaseInOut,
                      TransitionProperties: GalleryPosterTransitions.Module,
                      MinWidth: 72.0,
...
class MotionChapter : Cell {
  ...
  public init() {
    ...
    movingLength = Animate(Length.Percent(22.0))
  ...
  private func updateMotionActivity() {
    if active && showcase == 0 {
      ...
      movingLength.Set(Length.Percent(22.0))
      retargetMotion()
  ...
  private func retargetMotion() {
    ...
    if motionTowardEnd {
      ...
      movingLength.To(Length.Percent(78.0), GalleryMotionSpec)
    } else {
      movingPoint.To(Point{ X: 44.0, Y: 42.0 }, GalleryMotionSpec)
      movingColor.To(Color.Rgb(226, 100, 98), GalleryMotionSpec)
      movingLength.To(Length.Percent(22.0), GalleryMotionSpec)
    }
  }
  ...
  private func stateContent() Blob -> Container {
    Width: if Compact { Length.Percent(48.0) } else { Length.Percent(100.0) },
    MinWidth: 0.0,
    Height: 150.0,
    FlexGrow: 1.0,
    FlexDirection: FlexDirection.Column,
  ...
  private func pointerContent(height float64) Blob {
    if let assets = Assets {
      ...
      return Container{
        Width: if Compact { Length.Percent(100.0) } else { Length.Percent(66.0) },
        MinWidth: 0.0,
        Height: height,
        FlexGrow: 1.0,
        Position: PositionType.Relative,
  ...
  private func instrumentContent() Blob -> Container {
    ...
    Children: {
      ...
      Container{
        Width: if Compact { Length.Percent(100.0) } else { Length.Percent(32.0) },
        MinWidth: 0.0,
        Height: if Compact { 150.0 } else { 410.0 },
  ...
  private func ribbonContent() Blob {
    ...
    while value <= 49 {
      ...
      rows.Add(Container{
        ...
        BackgroundColor: fill,
        Children: {
          Text{ Content: value.ToString("D2"), FontSize: 12.0, FontWeight: 700.0, Color: GalleryTheme.Ink },
          Text{ Content: label, FontSize: 10.0, LetterSpacing: 0.6, Color: GalleryTheme.InkMuted },
        },
      })
      value = value + 1
    }

...
public partial class Window {
  private func toSdlState(value WindowState) SdlHostState {
    return switch value {
  ...
  private func fromSdlState(value SdlHostState) WindowState {
    return switch value {
  ...
  private func toSdlCursor(value Cursor) SdlHostCursor {
    return switch value {

...
internal data struct Rect {
  ...
  internal func Contains(x float32, y float32) bool {
...
internal class Node {
  ...
  internal prop Display Display {
    get { return (nodeState & int32(1)) != 0 ? Display.None : Display.Flex }
    set {
  ...
  internal prop Direction Direction {
    get { return Direction((nodeState >> 10) & int32(3)) }
    set {
  ...
  internal prop TextShadows BoxShadowStack? {
    get { return TextShadowing.Get(this) }
  ...
  internal prop TransitionEasing Easing {
    get { return Easing((nodeState >> 26) & int32(3)) }
    set {
  ...
  internal prop TransitionSelection StyleMask {
    get { return transitionSelection }
    set { transitionSelection = value }
  }
  internal prop Focusable bool {
    get { return (nodeState & (int32(1) << 14)) != 0 }
    set {
      nodeState = value ? nodeState | (int32(1) << 14)
        : nodeState & ^(int32(1) << 14)
    }
  }
  internal prop AutoFocus bool {
    get { return (lifecycleState & uint8(2)) != uint8(0) }
    set {
      lifecycleState = value ? lifecycleState | uint8(2) : lifecycleState & ^uint8(2)
    }
  }
  internal prop Disabled bool {
    get { return (nodeState & (int32(1) << 15)) != 0 }
    set {
      nodeState = value ? nodeState | (int32(1) << 15)
        : nodeState & ^(int32(1) << 15)
    }
  }
  internal prop Cursor Cursor {
    get { return Cursor((nodeState >> 16) & int32(31)) }
    set {
  ...
  internal prop TextWrap TextWrap {
    get { return (nodeState & (int32(1) << 21)) != 0 ? TextWrap.NoWrap : TextWrap.Wrap }
    set {
      nodeState = value == TextWrap.NoWrap ? nodeState | (int32(1) << 21)
        : nodeState & ^(int32(1) << 21)
    }
  }
  internal prop TextTrimming TextTrimming {
    get { return (nodeState & (int32(1) << 22)) != 0 ? TextTrimming.Ellipsis : TextTrimming.None }
    set {
      nodeState = value == TextTrimming.Ellipsis ? nodeState | (int32(1) << 22)
        : nodeState & ^(int32(1) << 22)
    }
  }
  internal prop HasOutlineState bool {
    get { return (nodeState & (int32(1) << 23)) != 0 }
    set {
      nodeState = value ? nodeState | (int32(1) << 23)
        : nodeState & ^(int32(1) << 23)
    }
  }
  internal prop Visibility Visibility {
    get { return (nodeState & int32(2)) != 0 ? Visibility.Hidden : Visibility.Visible }
    set {
  ...
  internal prop PaintInputState int32 { get { return nodeState & int32(3) } }
  internal prop PaintInputHidden bool { get { return (nodeState & int32(3)) != 0 } }
  internal prop StackingChildren bool {
    get { return (nodeState & (int32(1) << 24)) != 0 }
    set {
      nodeState = value ? nodeState | (int32(1) << 24)
        : nodeState & ^(int32(1) << 24)
    }
  }
  internal prop HasZIndex bool {
    get { return (nodeState & (int32(1) << 25)) != 0 }
    set {
      nodeState = value ? nodeState | (int32(1) << 25)
        : nodeState & ^(int32(1) << 25)
    }
  }
  internal prop HasBackgroundImageState bool {
    get { return (nodeState & (int32(1) << 28)) != 0 }
    set {
      nodeState = value ? nodeState | (int32(1) << 28)
        : nodeState & ^(int32(1) << 28)
    }
  }
  internal prop BackgroundImageFit ImageFit {
    get { return ImageFit((nodeState >> 29) & int32(3)) }
    set {
      nodeState = (nodeState & ^(int32(3) << 29)) | ((int32(value) & int32(3)) << 29)
    }
  }
  internal prop HasClipPath bool {
    get { return (nodeState & (int32(1) << 31)) != 0 }
    set {
      nodeState = value ? nodeState | (int32(1) << 31)
  ...
  internal prop ImageSource ImageSourceProvider? { get { return ImageLayouts.Source(this) } }
  internal prop ImageLease ImageSourceLease? { get { return ImageLayouts.Lease(this) } }
  internal prop ImageSourceCompletion ImageSourceCompletion? {
    get { return ImageLayouts.SourceCompletion(this) }
  }

...
internal func fromSdlPointerButton(value SdlHostPointerButton) PointerButton -> switch value {
...
internal func fromSdlPointerDevice(value SdlHostPointerDevice) PointerDevice -> switch value {

...
internal sealed class VulkanRetainedTextSnapshotStorage {
    internal func Snapshot(owner VulkanSceneOwnerId) VulkanRetainedTextSnapshot? {
        return owner.RetainedTextSnapshot
    }
    ...
    private func ValidBounds(value ConservativeBounds) bool {
...
internal partial class VulkanSceneCompiler {
    ...
    internal func CaptureRetainedTextSnapshot(
        owner VulkanSceneOwnerId,
        chunkIndex int32) bool {
        return retainedTextSnapshots.Capture(frame, owner, chunkIndex)
    }
    ...
    private func RetainedTextUnitTranslation(value PrimitiveTransform) bool {
        return ExactFloat(value.A, 1.0F)

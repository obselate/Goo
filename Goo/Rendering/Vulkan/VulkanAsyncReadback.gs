...
internal unsafe sealed class VulkanAsyncReadback : IDisposable {
    ...
    internal func Request(frame SceneFrame, clearColor VkClearColorValue) VkResult {
        return Request(frame, clearColor, VulkanReadbackPlan.Full(target.Extent).Region)
    }

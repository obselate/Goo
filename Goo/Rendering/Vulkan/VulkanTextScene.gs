...
internal struct VulkanTextAtlasGlyphKey : IEquatable[VulkanTextAtlasGlyphKey] {
    ...
    public func Equals(other VulkanTextAtlasGlyphKey) bool {
    ...
    public override func Equals(value object?) bool {
        return switch value {
...
internal unsafe sealed class VulkanTextScene {
    ...
    private func SameTextRecord(
        ...
        right HbGpuTextInstanceRecord) bool {
        return SameTextFloat(left.transform_m00, right.transform_m00)
    ...
    private func SameTextFloat(left float32, right float32) bool {

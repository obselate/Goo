...
internal unsafe sealed class VulkanPathResources : IDisposable {
    ...
    internal func RedrawRequiredSince(observedSequence uint64) bool {
        return redrawSequence > observedSequence
    }
    ...
    private func EmptyRenderable(fillRule FillRule) VulkanPathRenderable {
        return VulkanPathRenderable{
            PathId: ResourceId{},

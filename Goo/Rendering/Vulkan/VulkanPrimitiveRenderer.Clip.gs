...
internal unsafe partial class VulkanPrimitiveRenderer : IDisposable {
    ...
    internal func PrepareClipMasks(frame SceneFrame, extent VkExtent2D,
        ...
        return PrepareClipFrame(frame, extent, slotIndex, completedSubmissionSerial)
    }
    ...
    internal func RecordClipMasks(commandBuffer VkCommandBuffer, extent VkExtent2D) int32 {
        return RecordClipMaskPass(commandBuffer, extent)
    }
    ...
    private func Floor(value float32) float32 { return MathF.Floor(value) }
    private func Ceiling(value float32) float32 { return MathF.Ceiling(value) }
}

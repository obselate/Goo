...
internal unsafe sealed class VulkanClipMaskFrameSlot : IDisposable {
    ...
    internal func CanReuse(drawCount int32, byteCount VkDeviceSize) bool {
...
internal unsafe sealed class VulkanClipMaskFrameData : IDisposable {
    ...
    private func BitValue(value float32) uint32 {
        return uint32(BitConverter.SingleToInt32Bits(value))
    }

...
internal interface SystemFontResolver {
  func Find(family string, weight int32, italic bool) string?;
}

internal sealed class FileSystemFontResolver : SystemFontResolver {
...
internal class SystemFontResolvers {
  shared {
    private let current SystemFontResolver = FileSystemFontResolver()

    internal func Current() SystemFontResolver -> current
  }
}

...
- Local discrete-Linux implementation and qualification are complete. Remaining work is external hardware and final comparison-policy Q&A. Evidence is `artifacts/reports/s15-q10/clean-linux-6d4d92e-summary.json` plus its SHA-256 manifest.

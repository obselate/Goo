...
class S15Q10ThreeWindowRoot : Cell {
  shared {
  ...
  init(initialSeed uint64, initialWindowIndex int32, exactWidth int32, exactHeight int32) {
    ...
    Entry = ElementHandle{}
    leafKey = "q10-three-window-" + initialWindowIndex.ToString() + "-leaf"
    controlKey = "q10-three-window-" + initialWindowIndex.ToString() + "-control"
    entryKey = "q10-three-window-" + initialWindowIndex.ToString() + "-entry"

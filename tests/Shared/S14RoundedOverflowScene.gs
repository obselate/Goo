...
class S14RoundedOverflowCell : Cell {
  shared {
    ...
    let OuterClipPath VectorPath = PathBuilder()
      .MoveTo(0.5, 0.0)
      .LineTo(1.0, 0.5)
      .LineTo(0.5, 1.0)
      .LineTo(0.0, 0.5)
      .Close()
      .Build()
    let InnerClipPath VectorPath = PathBuilder()
      .MoveTo(0.5, 0.0)
      .LineTo(1.0, 1.0)
      .LineTo(0.0, 1.0)
      .Close()
  ...
  override func Build() Blob {
    return Container{
      ...
      Handle: S14RoundedOverflowCell.Root,
      ...
      Children: {
        Container{
          ...
          Handle: S14RoundedOverflowCell.HorizontalViewport,
          ...
          Children: {
            Container{
              ...
              Width: 240,
              Height: 72,
              Handle: S14RoundedOverflowCell.HorizontalContent,
              ...
              Children: {
                Container{
                  ...
                  Width: 112,
                  Height: 48,
                  Handle: S14RoundedOverflowCell.HorizontalStripe,
        ...
        Container{
          ...
          Handle: S14RoundedOverflowCell.VerticalViewport,
          ...
          Children: {
            Container{
              ...
              Width: 160,
              Height: 144,
              Handle: S14RoundedOverflowCell.VerticalContent,
              ...
              Children: {
                Container{
                  ...
                  Width: 120,
                  Height: 64,
                  Handle: S14RoundedOverflowCell.VerticalStripe,
        ...
        Container{
          ...
          Handle: S14RoundedOverflowCell.RoundedHidden,
          ...
          Children: {
            Text{
              ...
              Width: 82,
              Height: 28,
              Handle: S14RoundedOverflowCell.RoundedText,
              Content: "Clip",
              FontFamily: "S14GateFont",
              FontSize: 18,
              Color: Color.White,
            ...
            Image{
              ...
              Width: 42,
              Height: 42,
              Handle: S14RoundedOverflowCell.RoundedImage,
              Source: S14RoundedOverflowCell.SharedImageSource,
              Fit: ImageFit.Fill,
            },
            Container{
              Position: PositionType.Absolute,
        ...
        Container{
          ...
          Handle: S14RoundedOverflowCell.RoundedScroll,
          ...
          Children: {
            Container{
              ...
              Width: 248,
              Height: 96,
              Handle: S14RoundedOverflowCell.RoundedScrollContent,
              BackgroundColor: Color.Rgb(52, 196, 112),
              Children: {
                Container{
                  Position: PositionType.Absolute,
                  ...
                  Width: 110,
                  Height: 96,
                  Handle: S14RoundedOverflowCell.RoundedScrollStripe,
                  BackgroundColor: Color.Rgb(72, 128, 224),
                },
              },
            },
        ...
        Container{
          ...
          Width: 104,
          Height: 96,
          Handle: S14RoundedOverflowCell.ClipOuter,
          ClipPath: S14RoundedOverflowCell.OuterClipPath,
          ...
          Children: {
            Container{
              ...
              Width: 88,
              Height: 80,
              Handle: S14RoundedOverflowCell.ClipInner,
              ClipPath: S14RoundedOverflowCell.InnerClipPath,
              ClipPathFit: ShapeFit.Fill,
              ...
              Children: {
                Container{
                  ...
                  Width: 44,
                  Height: 34,
                  Handle: S14RoundedOverflowCell.TransformLeaf,

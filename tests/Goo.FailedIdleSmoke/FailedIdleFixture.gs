...
internal partial class VulkanWindowTarget {
    ...
    internal func FailedIdleSubmissionSerialsForTest() FailedIdleSubmissionSerialTestSnapshot {
        return FailedIdleSubmissionSerialTestSnapshot{
...
public partial class Window {
    ...
    internal func FailedIdleNeedsRenderForTest() bool {
        return windowTarget?.NeedsRender == true
    }
}

internal class FailedIdleTestFixture {
    shared {
        internal func Counters(window Window) VulkanDiagnosticCounterSnapshot {
            return window.FailedIdleCountersForTest()
        }
        ...
        internal func NeedsRender(window Window) bool {
            return window.FailedIdleNeedsRenderForTest()
        }

        internal func PrimitiveFrame(window Window) FailedIdlePrimitiveFrameTestSnapshot {
            return window.FailedIdlePrimitiveFrameForTest()
        }

        internal func TextFrame(window Window) FailedIdleTextFrameTestSnapshot {
            return window.FailedIdleTextFrameForTest()
        }

        internal func SubmissionSerials(window Window)
            FailedIdleSubmissionSerialTestSnapshot {
            return window.FailedIdleSubmissionSerialsForTest()
        }
    }
}

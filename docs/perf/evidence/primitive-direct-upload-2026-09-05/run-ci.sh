...
.github/scripts/with-headless-wayland.sh env GOO_VK_DIAGNOSTICS=1 GOO_DIRECT_PRIMITIVE_UPLOAD_SMOKE=1 dotnet tests/Goo.AsyncReadbackSmoke/bin/Release/net10.0/Goo.AsyncReadbackSmoke.dll

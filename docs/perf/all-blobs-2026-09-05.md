...
![CPU, RAM, GPU, and allocation overview](evidence/all-blobs-2026-09-05/results/final/overview.png)
...
- [Detailed values and three-run ranges](evidence/all-blobs-2026-09-05/results/final/analysis.md), [summary CSV](evidence/all-blobs-2026-09-05/results/final/summary.csv), and [per-run CSV](evidence/all-blobs-2026-09-05/results/final/runs.csv).
- [All timing runs](evidence/all-blobs-2026-09-05/results/final/runs.json), [validation calibration](evidence/all-blobs-2026-09-05/results/pilot/runs.json), and [independent coverage audit](evidence/all-blobs-2026-09-05/coverage-audit.json).
- [Source hashes](evidence/all-blobs-2026-09-05/source-hashes.json), [task-only patch](evidence/all-blobs-2026-09-05/task.patch), [binary hashes](evidence/all-blobs-2026-09-05/frozen-binaries.json), and [environment](evidence/all-blobs-2026-09-05/initial-environment.json).
- [Runner](evidence/all-blobs-2026-09-05/scripts/run.py), [analyzer](evidence/all-blobs-2026-09-05/scripts/analyze.py), and [chart generator](evidence/all-blobs-2026-09-05/scripts/plot.py).
